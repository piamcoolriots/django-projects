...
# this function takes a string, strips out all characters that aren’t numbers, and
# returns just the numbers as a string. We do this with the use of the Python regular expression module,
# finding all non-numeric digits and replacing them with an empty string
...
class CheckoutForm(forms.ModelForm):
    # overriding the default construction
    def __init__(self, *args, **kwargs):
        super(CheckoutForm, self).__init__(*args, **kwargs)
        # override default attributes
        for field in self.fields:
            self.fields[field].widget.attrs['size'] = '30'
        self.fields['shipping_city'].widget.attrs['size'] = '3'
    ...
    # # froms.select gives HTML select box
